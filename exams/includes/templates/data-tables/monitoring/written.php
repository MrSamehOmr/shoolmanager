...
?>
    <div class="section">
                ...
                <table>
                    ...
                    <tbody>
                        <tr rowname="monitoring">
                            ...
                            <td colname="aljebra"></td>
                            <td colname="geometry"></td>
        ...
        <div class="data-table written-table">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="cell-size-1 rotated-head" rowspan="1"><span>الجبر</span></th>
                            <th class="cell-size-1 rotated-head" rowspan="1"><span>الهندسة</span></th>
                        ...
                        <tr>
                            <?php
                            $degres = [70, 70, 70, 35, 35, 70, 70, 70, 70];
                            foreach ($degres as $d) {
                                echo "<th>";
