...
if (isset($_POST["ajax"]) && $_POST["ajax"] == 1) {
    ...
    include  $_SERVER["DOCUMENT_ROOT"] . "/general/includes/converters.php";

    $data = json_decode($_POST['dataName']);
    echo convertNumbers($data->dataValue);
    exit;
}
?>
        ...
        <div class="table-body">
            <table>
                ...
                <tbody>
                    ...
                    first_semester_evaluation.arabic,
                    first_semester_evaluation.english,
                    first_semester_evaluation.socialStudies,
                    first_semester_evaluation.math,
                    first_semester_evaluation.sciences,
                    first_semester_evaluation.activity_1,
                    first_semester_evaluation.activity_2,
                    first_semester_evaluation.religion,
                    first_semester_evaluation.computer,
                    draw,
                    20 as sports
                    FROM students_data 
                    LEFT JOIN first_semester_evaluation 
                    ON students_data.studentId = first_semester_evaluation.studentId 
                    WHERE grade = ?
                    ...
                    while ($row = $stmnt->fetch(PDO::FETCH_ASSOC)) {
                        $col_num = 1;
                        echo "<tr ";
                        echo $row_num % 2 == 0 ? "class='even'" : "class='odd'";
                        echo ">";
